...
final class ExportRequestGatingTests: XCTestCase {
    ...
    func test_cancelDuringPreload_nilActiveRequest() {
        let activeRequest: PlayerViewController.ActiveExportRequest? = nil
        let requestId = UUID()
    ...
    func test_cancelClosure_onlyClears_matchingRequest() {
        ...
        var activeRequest: PlayerViewController.ActiveExportRequest? = requestB
    ...
    func test_isExporting_computedFromActiveRequest() {
        var activeRequest: PlayerViewController.ActiveExportRequest?
