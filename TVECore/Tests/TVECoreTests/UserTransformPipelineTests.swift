...
final class UserTransformPipelineTests: XCTestCase {
    ...
    func testT1_identityTransform_matchesDefaultBehaviour() async throws {
        let json = lottieJSON()
    ...
    func testT2_translation_shiftMediaInsideInput() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testT3_scale_mediaScalesInsideInput() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testT4_rotation_mediaRotatesInsideInput() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testT5_userTransformPlusLottieAnimation_correctOrder() async throws {
        // Use animated scale (100→120 over 300 frames)
        let json = lottieJSON(animatedScale: true)
        let (package, animations) = try makeScenePackage(lottieJSON: json)

        let (cmdsF0, cmdsF150) = try await MainActor.run {
            let player = ScenePlayer()
            let compiled = try player.compile(package: package, loadedAnimations: animations)
    ...
    func testT6_exportDeterminism_sameInputsSameOutput() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testT6_exportDeterminism_separatePlayers() async throws {
        let json = lottieJSON()
        ...
        let (cmds1, cmds2) = try await MainActor.run {
    ...
    func testAPI_setAndGetUserTransform() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testAPI_unknownBlockId_returnsIdentity() async throws {
        try await MainActor.run {
            let player = ScenePlayer()
    ...
    func testAPI_resetAllUserTransforms() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testMultiBlock_transformIsolation() async throws {
    ...
    func testSceneRenderPlan_defaultParameter_matchesNoTransforms() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testSceneRenderPlan_forwardsUserTransform() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testBackwardsCompat_renderWithoutSettingTransform() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
    ...
    func testBackwardsCompat_sceneRuntimeConvenience() async throws {
        let json = lottieJSON()
        let (package, animations) = try makeScenePackage(lottieJSON: json)
