...
final class ScenePlayerRenderIntegrationTests: XCTestCase {
    ...
    func testScene_frame30_block1HasNonZeroPixels() async throws {
        // Given - loading package can stay outside
    ...
    func testScene_frame60_block2HasNonZeroPixels() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_frame90_block3HasNonZeroPixels() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_frame120_block4HasNonZeroPixels() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_frame150_block4HasNonZeroPixels() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_frame150_multipleBlocksRender() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_commandsHaveCorrectClipRects() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
    ...
    func testScene_identityTransformWhenFullCanvas() async throws {
        // Given - loading package can stay outside
        let (package, animations) = try loadTestPackage()
